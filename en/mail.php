...
// 主旨
$subject= "hello~有人在LWIS-EN聯繫我們";  // $subject= "$nowtime hello~有人在LWIS-EN聯繫我們";
...
function mail_attach($to, $bcc, $fromname, $from, $subject, $message){  //,$file_name(檔案為註解處)  $nowtime, 
    ...
    //不讓人看到傳送訊息避免收到垃圾郵件
    echo '<script>setTimeout(function(){window.alert("There is a problem with sending, please call or email tradingcornerstone@gmail.com during business hours.");history.back(-1);},2000);</script>';
    // echo '
    // <script>
    // setTimeout(function(){
